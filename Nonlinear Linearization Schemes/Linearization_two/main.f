...
*
 10     CALL NULL(BT, IB,IE,ID)
        CALL DIFPHI(DE, COND,AREP,DIEP,IB,IE,ID)
        CALL SRCT(QT,RT, T,VOLP,ARO,HCONV,TINF,
     C            SBC,EMIS,IB,IE,ID)
...
***************************************************************     
      ...
      WRITE(*,*)'ITERARION NO:',ITER
      WRITE(*,*)'AVERAGE RES:',AVRSD	

***************************************************************
* start the loop if the convergence criteria is not satisfied
***************************************************************

      IF(AVRSD.GT.CRIT.AND.ITER.LT.IMAX) THEN
      ...
      END IF
***************************************************************
      WRITE(*,*)'SOLUTION CONVERGED LOOOOL'
