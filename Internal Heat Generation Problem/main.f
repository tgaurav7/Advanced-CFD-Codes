...
*
     ...
     C          LVLGEO,LVLCOF,HCONV,TINFE,TINFW,TINF,IDATI)
      CALL ECHO(IB,IE,IDTYP,DI,
     C          RHO,COND,CP,VISC,EMIS,
     C          T0,DTIME,KNTTM,KNTNL,CRIT,
     C          LVLGEO,LVLCOF,HCONV,TINFE,TINFW,TINF,IDATO)
*
...
*
        CALL BNDCT(ATP,ATW,ATE,BT,HCONV,DE,AREP,TINFW,TINFE,IB,IE,ID)
*
