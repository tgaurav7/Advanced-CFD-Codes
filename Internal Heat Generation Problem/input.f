...
*
     ...
     C                 LVLGEO,LVLCOF,HCONV,TINFE,TINFW,
     C                 TINF,IDATI)
*
...
*
     ...
     C                RHO,COND,CP,VISC,EMIS,
     C                T0,DTIME,KNTTM,KNTNL,CRIT,
     C                LVLGEO,LVLCOF,HCONV,
     C                TINFE,TINFW,TINF,IDATO)
*
...
*
      ...
      WRITE(IDATO,6030) LVLGEO,LVLCOF,HCONV,TINFE,TINFW,TINF
*
 6000 FORMAT('              IB = ',I5,/
     C      ,'              IE = ',I5,/
     C      ,'           IDTYP = ',I5,/
